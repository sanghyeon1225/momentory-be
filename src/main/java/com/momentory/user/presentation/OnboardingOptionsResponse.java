...
import com.momentory.user.application.OnboardingOptionResult;
import com.momentory.user.application.OnboardingOptionsResult;
import com.momentory.user.application.NicknamePolicyResult;
